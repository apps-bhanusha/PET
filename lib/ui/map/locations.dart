...
class GetAllTurfResponse {
  ...
  factory GetAllTurfResponse.fromMap(Map<String, dynamic> json) => GetAllTurfResponse(
    ...
    data: json["data"] == null ? null : List<GetAllTurfData>.from(json["data"].map((x) => GetAllTurfData.fromMap(x))),
  );
...
class GetAllTurfData {
  ...
  factory GetAllTurfData.fromMap(Map<String, dynamic> json) => GetAllTurfData(
    ...
    tblTurfSports: json["tbl_turf_sports"] == null ? [] : List<TblTurfSport>.from(json["tbl_turf_sports"].map((x) => TblTurfSport.fromMap(x))),
    tblTurfFacilities: json["tbl_turf_facilities"] == null ? [] : List<TblTurfFacility>.from(json["tbl_turf_facilities"].map((x) => TblTurfFacility.fromMap(x))),
    tblTurfImages: json["tbl_turf_images"] == null ? [] : List<TblTurfImage>.from(json["tbl_turf_images"].map((x) => TblTurfImage.fromMap(x))),
    tblTurfPrices: json["tbl_turf_prices"] == null ? [] : List<TblTurfPrice>.from(json["tbl_turf_prices"].map((x) => TblTurfPrice.fromMap(x))),
  );
  ...
  Map<String, dynamic> toMap() => {
    ...
    "tbl_turf_facilities": tblTurfFacilities == null ? null : List<dynamic>.from(tblTurfFacilities.map((x) => x.toMap())),
